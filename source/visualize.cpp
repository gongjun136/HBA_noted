...
int main(int argc, char **argv)
{
  ...
  pcl::io::savePCDFile(file_path+"map.pcd", *accumulated_cloud);
  LOG(INFO) << "Saved accumulated point cloud map to 'map.pcd'" ;
